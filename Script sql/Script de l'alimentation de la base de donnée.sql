INSERT INTO artisanentreprise (id_artisan,nom,specialite,note,ville,a_propos,email,site_web,categorie,top)
VALUES 
...
('14','Cest suphair','Coiffeur','4.1','Romans-sur-Isère','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eleifend ante sem, id volutpat massa fermentum nec. Praesent volutpat scelerisque mauris, quis sollicitudin tellus sollicitudin. ','sup-hair@gmail.com','https://sup-hair.fr','Services','FALSE'),
