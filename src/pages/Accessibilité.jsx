import "../assets/CSS_JS/Accessibilité.css";
                  ...
                  <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item text-uppercase"><Link className="nav-link" to="/Portfolio">portfolio</Link></li>
                        <li className="nav-item text-uppercase"><Link className="nav-link" to="/Contact">contact</Link></li>
                        <li className="nav-item text-uppercase"><Link className="nav-link" to="/MentionsLegales">mention légales</Link></li>
                      </ul>
                    </div>
                  </div>
                </nav>
